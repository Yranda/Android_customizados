...
public class MainActivity extends ActionBarActivity
    ...
    public void proxlayout (View v) {
        startActivity(new Intent(this, dominando.android.ex04_result.seglayout.class));
    }

    public void setContenteView(int contenteView) {
        this.contenteView = contenteView;
    }
}
